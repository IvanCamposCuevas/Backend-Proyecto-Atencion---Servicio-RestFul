...
namespace ServicioAtencion.Controllers
{
    public class AtencionController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public bool postAgregarAtencion(Atencion atencion)
        {
            bool resultado;
            bool existe;
        ...
        [HttpGet]
        public List<ServicioDTO> getObtenerServicios()
        {
            List<ServicioDTO> listaServicio = new List<ServicioDTO>();
            using (BDAtencionEntities bd = new BDAtencionEntities())
            {
                listaServicio = bd.servicio.Select(x => new ServicioDTO
                {
